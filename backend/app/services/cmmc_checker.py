...
_CONTROLS: list[CMMCControl] = [
    ...
    CMMCControl(
        ...
        "AT.L2-3.2.2",
        "Training",
        "Ensure personnel are trained to carry out assigned duties.",
        2,
        False,
    ),
    # Audit & Accountability
    CMMCControl(
        CMMCDomain.AUDIT_ACCOUNTABILITY,
        "AU.L2-3.3.1",
        "System Auditing",
    ...
    CMMCControl(
        CMMCDomain.CONFIGURATION_MANAGEMENT,
        "CM.L2-3.4.1",
        "System Baselining",
    ...
    CMMCControl(
        CMMCDomain.IDENTIFICATION_AUTH,
        "IA.L1-3.5.1",
        "Identification",
    ...
    CMMCControl(
        ...
        "PS.L2-3.9.2",
        "Personnel Actions",
        "Protect CUI during personnel actions such as terminations.",
        2,
        False,
    ),
    # Physical Protection
    CMMCControl(
        CMMCDomain.PHYSICAL_PROTECTION,
        "PE.L1-3.10.1",
        "Physical Access",
    ...
    # Risk Assessment
    CMMCControl(
        CMMCDomain.RISK_ASSESSMENT,
        "RA.L2-3.11.1",
        "Risk Assessment",
        "Periodically assess risk to operations and assets.",
        2,
        False,
    ),
    CMMCControl(
    ...
    # Security Assessment
    CMMCControl(
        CMMCDomain.SECURITY_ASSESSMENT,
        "CA.L2-3.12.1",
    ...
    CMMCControl(
        ...
        "SC.L2-3.13.8",
        "CUI in Transit",
        "Implement cryptographic mechanisms to prevent unauthorized CUI disclosure during transmission.",
        2,
        True,
    ),
    # System & Information Integrity
    CMMCControl(
        CMMCDomain.SYSTEM_INFO_INTEGRITY,
        "SI.L1-3.14.1",
        "Flaw Remediation",
...
def get_compliance_score() -> dict:
    ...
    for d in domain_map.values():
        d["percentage"] = (
            round(d["met_controls"] / d["total_controls"] * 100) if d["total_controls"] else 0
        )
        domains.append(d)
