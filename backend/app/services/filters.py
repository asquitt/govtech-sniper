...
from app.models.user import UserProfile, ClearanceLevel
...
Respond in this exact JSON format:
{
    ...
    def _build_rfp_summary(self, rfp: RFP) -> str:
        ...
        if rfp.description:
            ...
            desc = rfp.description[:2000] + "..." if len(rfp.description) > 2000 else rfp.description
            lines.append(f"\nDESCRIPTION:\n{desc}")
...
def quick_disqualify(rfp: RFP, profile: UserProfile) -> Optional[str]:
    """
