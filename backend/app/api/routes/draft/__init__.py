...
from app.api.routes.draft.focus_documents import router as focus_documents_router
from app.api.routes.draft.outline import router as outline_router
...
router.include_router(focus_documents_router)
